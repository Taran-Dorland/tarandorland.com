<?php
    ...
    $JSON = file_get_contents("../node_modules/warframe-items/data/json/Secondary.json");
    ...
    foreach ($obj as $key => $val) {
        ...
        if (isset($val['ammo']) && isset($val['damage'])) {
            $sql = "INSERT INTO wf_secondary_weapons(Name, Type, Mag_Size, Reload_Time, Max_Ammo, Damage, Damage_Type, Fire_Rate, Dps, Accuracy, Crit_Chance, Crit_Mult, Status_Chance, Polarities) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?);";
            ...
            $sql = "INSERT INTO wf_secondary_weapons(Name, Type, Mag_Size, Reload_Time, Damage_Type, Fire_Rate, Dps, Accuracy, Crit_Chance, Crit_Mult, Status_Chance, Polarities) VALUES(?,?,?,?,?,?,?,?,?,?,?,?);";
            $stmt = $pdo -> prepare($sql);
            ...
            $sql = "INSERT INTO wf_secondary_weapons(Name, Type, Mag_Size, Reload_Time, Max_Ammo, Damage_Type, Fire_Rate, Dps, Accuracy, Crit_Chance, Crit_Mult, Status_Chance, Polarities) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?);";
            $stmt = $pdo -> prepare($sql);
            ...
            $sql = "INSERT INTO wf_secondary_weapons(Name, Type, Mag_Size, Reload_Time, Damage, Damage_Type, Fire_Rate, Dps, Accuracy, Crit_Chance, Crit_Mult, Status_Chance, Polarities) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?);";
            $stmt = $pdo -> prepare($sql);
