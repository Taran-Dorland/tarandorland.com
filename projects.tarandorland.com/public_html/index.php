...
<body>
    <main>
        <div class="container">
            <nav class="custom-nav" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item" aria-current="page"><a class="breadcrumb-link-item" href="https://tarandorland.com">Home</a></li>
                ...
                <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="Includes/img/dmuExtensionUtility/importpage.png" class="d-block w-100" alt="Main landing page.">
                        </div>
                        <div class="carousel-item">
                            <img src="Includes/img/dmuExtensionUtility/graph.png" class="d-block w-100" alt="Account login page.">
                        </div>
                        <div class="carousel-item">
                            <img src="Includes/img/dmuExtensionUtility/table.png" class="d-block w-100" alt="Successful connection page.">
                        </div>
                        <div class="carousel-item">
